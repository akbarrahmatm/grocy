...
#[Signature('app:convert-json-product-to-csv')]
#[Description('Convert products.json to products.csv')]
class ConvertJsonProductToCsv extends Command
{
    public function handle(): int
    {
        return $this->convert(
            resource_path('csv/products.json'),
            resource_path('csv/products.csv')
        );
    }
